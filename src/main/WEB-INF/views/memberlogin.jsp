...
<BODY>
	<div id="content">
		...
		<hr color="green">
		<a href="memberinfo?mid=${Mid}"> 
		${Mid}님의 개인 정보 보기 </a><br> 
		<a href="matchinsert.jsp"> 
		${Mid}님의 매칭 정보 입력하기 </a><br> 
		<a href="match_info?mid=${Mid}"> 
		${Mid}님의 매칭 정보 보기 </a><br> 
		<a href="main.jsp">메인으로 돌아가기</a>
		<br> 
		<a href="memberlogout.jsp">로그아웃하기</a>
