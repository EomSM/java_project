		...
		<form action="matchinsert">
			<table border="1"
				...
				<tr>
					...
					<td><input type="radio" name="drink" value="1" checked>전혀
				...
				<tr>
					<th>3 흡연:</th>
					<td><input type="radio" name="smoke" value="1" checked>흡연자에요<input
						type="radio" name="smoke" value="2">담배를 전혀 피우지 않아요</td>
				</tr>
				<tr>
					<th>4 종교:</th>
					<td><input type="radio" name="believe" value="1" checked>개신교
				...
				<tr>
					<th>5 키:</th>
					<td><input name="tall" value="170">cm</td>
				</tr>
				<tr>
					<th>6 MBTI:</th>
					<td><input type="text" name="mbti" value="ESTJ"><a
						href="https://www.16personalities.com/ko/"> 참조: MBTI성격유형테스트</a></td>
				</tr>
				<tr>
					<th>7 선호장소:</th>
					<td><input type="radio" name="place" value="1" checked>실내
						<input type="radio" name="place" value="2">야외</td>
				</tr>
				<tr>
					<th>8 선호연락수단:</th>
					<td><input type="radio" name="contact" value="1" checked>카톡
